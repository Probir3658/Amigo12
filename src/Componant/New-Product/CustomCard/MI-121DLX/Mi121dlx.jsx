...
const Herosec = () => {
  ...
  return (
    <>
    <div className="margin12"></div>
    <div className="hero-sec content-div margin12">
      ...
      <div className="hero-row">
        ...
        <div className="hero-col hero-col2">
          <div className="col2-wrapper">
            <h1 className="main-heading">121 DLX</h1>
            <p className="hero-para">
              <ol>
                <li className="mb-3" ><span>&#8226;</span>&nbsp;&nbsp;12-digit desktop calculator,
                </li>
                <li className="my-3"><span>&#8226;</span>&nbsp;&nbsp; Disp / GT / MU
                </li>
            ...
            <span className="dollar">INR-359</span>
            <span className="discount hero-subHeading">10%</span>
            <del className="discount2 hero-para">INR-399</del>
