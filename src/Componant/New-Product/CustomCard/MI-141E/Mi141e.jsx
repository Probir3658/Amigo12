      ...
      <div className="hero-row">
        ...
        <div className="hero-col hero-col2">
          <div className="col2-wrapper">
            ...
            <ol>
                <li className="mb-3" ><span>&#8226;</span>&nbsp;&nbsp; 14-digit Large Calculator,
                </li>
                <li className="my-3"><span>&#8226;</span>&nbsp;&nbsp; Tilt Display,
                </li>
            ...
            <span className="dollar">INR-521</span>
            <span className="discount hero-subHeading">10%</span>
            <del className="discount2 hero-para">INR-579</del>
